...
const enableCors = (req, res) => {
  ...
  res.setHeader('Access-Control-Allow-Origin', '*');  // You can specify specific origins if needed
...
module.exports = async (req, res) => {
  ...
  try {
    // Handle GET request (health check or basic status)
    if (req.method === 'GET') {
      return res.status(200).json({ message: 'Transfer API is up and running!' });
    }
